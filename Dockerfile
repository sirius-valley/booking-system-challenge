...
# docker build -t booking_system_challenge .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name booking_system_challenge booking_system_challenge
